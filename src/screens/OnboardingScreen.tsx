...
const SLIDES: {
...
}[] = [
  {
    ...
    subtitle:
      'Track every rupee, understand your habits, and make better decisions with your finances.',
  },
  {
    ...
    title: 'Insights that\nactually help',
    subtitle:
      'Spending patterns, weekly trends, and a live Karma Score that keeps you accountable.',
  },
  {
    ...
    title: 'Set goals.\nStay on track.',
    subtitle:
      'Savings goals, budget limits, no-spend challenges. Build habits that compound over time.',
  },
];
          ...
          >
            ...
            <Animated.View style={{ transform: [{ translateY: slideAnim }] }}>
              <View style={styles.setupHeader}>
                ...
                <Text style={styles.setupSub}>10 seconds and you're in.</Text>
              </View>
              ...
              <Button
                label={loading ? 'Setting up...' : 'Get started'}
                ...
                {SLIDES.map((_, dotIndex) => (
                  <View
                    ...
                    style={[
                      ...
                      {
                        backgroundColor:
                          dotIndex === step ? '#6366F1' : '#1F2D3D',
                        width: dotIndex === step ? 20 : 6,
                      },
                    ]}
                  />
                ))}
